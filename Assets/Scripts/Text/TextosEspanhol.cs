...
"\r\nel aprendizaje se desarrolla.\r\n\r\n";
        ...
        textos[(int)ChaveTextos.SALA_DE_AULA_INVERTIDA] = "Clase invertida (AI)";
        ...
        textos[(int)ChaveTextos.SALA_DE_AULAB] = "Clase";
        ...
        textos[(int)ChaveTextos.SOBRE_O_COMMENIUS_3] = "Game Comenius 3 es un juego casual, de estrategia y simulación que apuesta por los medios digitales, las metodologías activas y las inteligencias múltiples.\r\n      Game Comenius es parte de un proyecto de educación en medios que investiga cómo un juego digital puede enseñar a estudiantes universitarios y profesores de todos los niveles educativos a utilizar los medios en el Clase, a educar “con”, “sobre” y “a través” de ellos.";
        ...
        textos[(int)ChaveTextos.ESCOLHA_DUAS_MIDIAS] = "Elegir los dos medios que se utilizarán en el clase";
        ...
        textos[(int)ChaveTextos.TRADICIONAL] = "<style=\"title\">Tradicional</style>\r\n\r\nLos medios tradicionales son aquellos que se consideran la base de la educación escolar y conforman el \"estándar del clase clases\" en el imaginario de la sociedad occidental desde hace siglos. Están presentes en todos los espacios educativos y se considera que los docentes saben planificar con ellas a través de la experiencia vivida en su propia formación. Su apoyo es material y físico y puede estar en papel (cuadernos, carteles o fotografías), sobre papel impreso (libro, periódicos y revistas), o fijado en el clase, como una pizarra.";
        ...
        textos[(int)ChaveTextos.SEQUENCIA_DICATICA2] = "Secuencia didáctica, en el clase:\r\n\r\n1. Explorar el material\r\n\r\n2. Discutir con el grupo en el clase\r \n \r\n3. Realizar actividades";
        textos[(int)ChaveTextos.NA_SALA_DE_AULA_INVERTIDA_DOCENTE] = "En el Flipped Classroom, el docente propone contenidos y actividades para realizar en casa por los estudiantes, a través de materiales como videos, podcasts o lectura de textos, etc. Luego del estudio previo al tema, los estudiantes llevan sus dudas al clase, reflexionan en grupos y desarrollan proyectos.";
        textos[(int)ChaveTextos.MIDIAS_QUARTO] = "<b>Medias - Cuarto</b>";
        textos[(int)ChaveTextos.NA_SEQUENCIA] = "Siguiendo el <b>Clase Invertida</b>, este es el momento en que los estudiantes:";
        textos[(int)ChaveTextos.MIDIAS_SALA] = "<b>Medios - Clase</b>";
        textos[(int)ChaveTextos.CONHECER_SALA_INVERTIDA] = "¿Aprendamos un poco más sobre el Clase Invertida?";
        ...
        textos[(int)ChaveTextos.O_PROBLEMA_DO_PROJETO] = "El problema del proyecto es multidimensional y altamente interactivo, ya que inserta a los participantes en un proceso de investigación estructurado en torno a cuestiones complejas. Ante esto, el gran aporte de esta metodología en el clase radica en el énfasis sobre el proceso de aprendizaje y la interacción entre los estudiantes.\r\n\r\n\r\nLos proyectos permiten unificar varios aspectos importantes del proceso de aprendizaje: la acción realizada por el estudiante, la intencionalidad de esta acción y su inserción. en un contexto social.\r\n";
        ...
        textos[(int)ChaveTextos.ESCOLHAS_AS_DUAS_MIDIAS] = "Elegir los dos medios que se utilizarán en el clase";
        ...
        textos[(int)ChaveTextos.DISCUTIR_COM_O_GRUPO] = "Debatir con el grupo en el clase.";
        ...
        textos[(int)ChaveTextos.VOCE_CONCLUIU_A_PRIMEIRA_PARTE] = "¡Has completado la primera parte de esta metodología! ¡Ahora tu planificación continuará en el clase!";
        ...
        textos[(int)ChaveTextos.SUA_AULA_QUARTO] = "Su clase se llevará a cabo en el DORMITORIO DEL ESTUDIANTE y en el clase.";
        textos[(int)ChaveTextos.SUA_AULA_CIDADE] = "Tu clase se realizará en la CIUDAD y en el clase";
