...
public sealed class NivelDeEnsino
{
    ...
    (
        ...
        expansao: "É a primeira etapa da Educação Básica tendo os princípios de educar e cuidar como indissociáveis buscando o objetivo de ampliar o " +
        "universo de experiências, conhecimentos e habilidades de bebês e crianças através da parceria com a família. É oferecida em creches para crianças de " +
        "até 3 anos de idade em pré-escolas para crianças de 4 a 5 anos (sendo esta obrigatória a matrícula). Tem como eixos estruturantes das práticas " +
        "pedagógicas as interações e a brincadeira por meio de intencionalidade educativa e a garantia de seis direitos de aprendizagem e desenvolvimento que " +
        "permeiam cinco campos de experiências tendo como finalidade o desenvolvimento integral da criança até 5 anos.",
    ...
    (
        ...
        expansao: "Etapa obrigatória com duração de 9 anos (dos 6 aos 14 anos), tendo como objetivo a formação básica do cidadão. É dividido em duas fases: " +
        "Anos Iniciais (1º ao 5º ano) e Anos Finais (6º ao 9º ano), que inicia-se em torno dos interesses manifestados pelas crianças até desafios de maior " +
        "complexidade. Sendo importante buscar o fortalecimento da autonomia dos estudantes nesse nível de ensino, desenvolvendo sua capacidade de aprendizagem " +
        "tendo em vista a aquisição de conhecimentos e habilidades e a formação de atitudes e valores que se fundamentam a sociedade.",
        areasDeConhecimento: new int[]
        {
    ...
    (
        ...
        expansao: "Etapa final da Educação Básica tem como finalidades o aprofundamento dos conhecimentos adquiridos anteriormente, a preparação básica para o " +
        "trabalho e a cidadania, a formação ética e o aprimoramento do pensamento crítico através da compreensão dos fundamentos científico-tecnológicos dos " +
        "processos produtivos, relacionando a teoria com a prática através de 4 grandes áreas do conhecimento produzindo múltiplas culturas juvenis promovendo " +
        "uma educação integral no que concerne os aspectos físicos, cognitivos e socioemocionais.",
        areasDeConhecimento: new int[]
        {
    ...
    (
        ...
        expansao: "É o nível que busca o desejo de aperfeiçoamento cultural e profissional estimulando o conhecimento dos problemas do mundo presente, " +
        "buscando prestar serviços especializados à comunidade através da pesquisa científica e tecnológica. Além de buscar o aprimoramento da educação básica " +
        "mediante a formação e a capacitação de profissionais através de pesquisas pedagógicas e o desenvolvimento de atividades de extensão em prol do " +
    ...
    private NivelDeEnsino(int valor, string nome, string descricao, string expansao, int[] areasDeConhecimento)
    {
        this.valor = valor;
        this.nome = nome;
