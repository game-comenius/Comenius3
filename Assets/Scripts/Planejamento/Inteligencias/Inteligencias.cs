...
public sealed class Inteligencias
{
    ...
    (
        ...
        "\n\nNaturalista:\nRefere-se à capacidade de compreender o mundo natural, identificando e distinguindo entre diferentes tipos de plantas, " +
        "animais e formações climáticas."
    );
    ...
    (
        ...
        expansao: "Intrapessoal:\nRefere-se à capacidade das pessoas de reconhecerem a si mesmos, percebendo seus sentimentos, motivações e desejos. " +
        "Está ligada à capacidade de identificar seus hábitos inconscientes, transformar suas atitudes, controlar vícios e emoções.\n\nEspacial-visual:" +
        "\nLigada à percepção visual e espacial, à interpretação e criação de imagens visuais e à imaginação pictórica. Ela permite que as pessoas compreendam " +
        "melhor informações gráficas, como mapas."
    );
    ...
    (
        ...
        expansao: "Interpessoal:\nRefere-se à capacidade de se relacionar com os outros, e o estilo de aprendizado ligado a esse tipo de inteligência envolve " +
        "contato humano, trabalho em equipe e comunicação.\n\nMusical:\nPermite aos indivíduos produzir, compreender e identificar os diferentes tipos de som, " +
        "reconhecendo  harmonias, melodias, padrões tonais, e rítmicos."
    );
    ...
    (
        ...
        expansao: "Linguística:\nRefere-se à capacidade de um indivíduo de se expressar, seja por meio da linguagem ou de gestos. " +
        "Assim como a forma de analisar e interpretar ideias e informações, e produzir trabalhos envolvendo linguagem oral e escrita.\n\nLógico-matemática:" +
        "\nVoltado para conclusões baseadas na razão, e descreve a capacidade de resolver equações e provas, de ter pensamento lógico, detectar padrões, " +
        "fazer cálculos e resolver problemas abstratos."
    );
    ...
    private Inteligencias(int valor, string nome, string descricao, string expansao)
    {
        this.Valor = valor;
        this.Nome = nome;
