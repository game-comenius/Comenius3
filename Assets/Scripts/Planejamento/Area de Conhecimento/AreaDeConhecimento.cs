...
public sealed class AreaDeConhecimento
{
    ...
    public static readonly AreaDeConhecimento EuOutroNos = new AreaDeConhecimento(0, 
        ...
        "<b>O eu, o outro e o nós</b>\n\nÉ na interação com os pares e com adultos que as crianças ressignificam sua aprendizagem, diferenciando-se e identificand" +
        "o-se como seres individuais e sociais valorizando sua identidade, respeitando os outros e reconhecendo suas diferenças que nos constituem como seres humanos.");
    public static readonly AreaDeConhecimento CorpoGestosMovimentos = new AreaDeConhecimento(1, 
        "Corpo, gestos e movimentos", 
        "<b>Corpo, gestos e movimentos</b>\n\nA exploração do mundo, através do corpo e dos sentidos, estabelecendo relações e produzindo conhecimento sobre o universo" +
        " social e cultural, através de diferentes linguagens corporais animadas pelo lúdico e na interação com seus pares para descobrir variados modos de ocupação e uso do espaço com o corpo.");
    public static readonly AreaDeConhecimento TracosSonsCoresFormas = new AreaDeConhecimento(2, 
        "Traços, sons, cores e formas", 
        "<b>Traços, sons, cores e formas</b>\n\nAtravés de experiências diversificadas, vivenciar diversar formas de expressão e linguagens contribuindo para desenvolver" +
        " a sensibilidade, o senso estético e crítico, além da criatividade e da expressão pessoal para criarem seu próprio repertório artístico e cultural.");
    public static readonly AreaDeConhecimento EscutaFalaPensamentoImaginacao = new AreaDeConhecimento(3, 
        "Escuta, fala, pensamento e imaginação", 
        "<b>Escuta, fala, pensamento e imaginação</b>\n\nPor meio das interações, progressivamente, as crianças vão ampliando a compreensão da linguagem oral e seus meios de comu" +
        "nicação no cotidiano. Assim como sua curiosidade sobre a cultura escrita através da literatura infantil, desenvolvendo sua imaginação e ampliando seu conhecimento de mundo.");
    public static readonly AreaDeConhecimento EspacosTemposQuantidadesRelacoesTransformacoes = new AreaDeConhecimento(4, 
        ...
        "<b>Espaços, tempos, quantidades, relações e transformações</b>\n\nAs crianças demonstram curiosidade sobre os espaços e tempos de diferentes dimensões em um mundo constituído de fenômenos" +
        " naturais e socioculturais, nos quais, os conhecimentos matemáticos estão também inseridos, fazendo os pequenos, através " +
        "da exploração do ambiente, entender melhor o seu uso no cotidiano e suas relações e transformações.");

    // Áreas de conhecimento do Ensino Fundamental
    public static readonly AreaDeConhecimento Linguagens = new AreaDeConhecimento(7, 
        "Linguagens", 
        "<b>Linguagens</b>\n\nÉ composta pelos seguintes componentes curriculares: Língua Portuguesa, Arte, Educação Física e, no Ensino Fundamental – " +
        "Anos Finais, Língua Inglesa. A finalidade é possibilitar aos estudantes participar de práticas de linguagens diversificad" +
        "as, que lhes permitam ampliar suas capacidades expressivas em manifestações artísticas, corporais e linguísticas, como ta" +
        "mbém seus conhecimentos sobre essas linguagens.");
    public static readonly AreaDeConhecimento Matematica = new AreaDeConhecimento(8, 
        "Matemática", 
        "<b>Matemática</b>\n\nA Matemática cria sistemas abstratos, que organizam e inter-relacionam fenômenos do espaço, do movimento, das formas e do" +
        "s números, associados ou não a fenômenos do mundo físico. Esses sistemas contêm ideias e objetos que são fundamentais par" +
        "a a compreensão de fenômenos, a construção de representações significativas e argumentações consistentes nos mais variado" +
        "s contextos.");
    public static readonly AreaDeConhecimento CienciasDaNatureza = new AreaDeConhecimento(9, 
        "Ciências da Natureza", 
        "<b>Ciências da Natureza</b>\n\nPor meio de um olhar articulado de diversos campos do saber, busca assegurar aos estudantes do Ensino Fundamental o acess" +
        "o à diversidade de conhecimentos científicos produzidos ao longo da história, bem como a aproximação gradativa aos princi" +
        "pais processos, práticas e procedimentos da investigação científica através do letramento científico.");
    public static readonly AreaDeConhecimento CienciasHumanas = new AreaDeConhecimento(10, 
        "Ciências Humanas", 
        "<b>Ciências Humanas</b>\n\nContribui para que os estudantes desenvolvam a cognição in situ, ou seja, sem prescindir da contextualização marcada pela" +
        "s noções de tempo e espaço, baseando-se na ideia de que o ser humano produz o espaço em que vive, apropriando-se dele em " +
        "determinada circunstância histórica, valorizando a crítica sistemática à ação humana, às relações sociais e de poder e, e" +
        "specialmente, à produção de conhecimentos e saberes.");
    public static readonly AreaDeConhecimento EnsinoReligioso = new AreaDeConhecimento(12, 
        "Ensino Religioso", 
        "<b>Ensino Religioso</b>\n\nO conhecimento religioso busca investigar a manifestação dos fenômenos religiosos em diferentes culturas e sociedades enq" +
        "uanto um dos bens simbólicos resultantes da busca humana por respostas aos enigmas do mundo, da vida e da morte, de modo " +
        "singular, complexo e diverso.");
    ...
    public static readonly AreaDeConhecimento LinguagensESuasTecnologias = new AreaDeConhecimento(13, 
        ...
        "<b>Linguagens e suas Tecnologias</b>\n\nO foco está na ampliação da autonomia, do protagonismo e da autoria nas práticas de diferentes linguagens; na identificaç" +
        "ão e na crítica aos diferentes usos das linguagens, explicitando seu poder no estabelecimento de relações; na apreciação " +
        "e na participação em diversas manifestações artísticas e culturais e no uso criativo das diversas mídias.");
    public static readonly AreaDeConhecimento MatematicaESuasTecnologias = new AreaDeConhecimento(14, 
        "Matemática e suas Tecnologias", 
        "<b>Matemática e suas Tecnologias</b>\n\nOs estudantes devem utilizar conceitos, procedimentos e estratégias não apenas para resolver problemas, mas também para f" +
        "ormulá-los, descrever dados, selecionar modelos matemáticos e desenvolver o pensamento computacional, por meio da utiliza" +
        "ção de diferentes recursos da área.");
    ...
    public static readonly AreaDeConhecimento CienciasHumanasESociaisAplicadas = new AreaDeConhecimento(16, 
        ...
        "<b>Ciências Humanas e Sociais Aplicadas</b>\n\nAmplia essa base conceitual e, mantendo referência às principais categorias da área, concentra-se na análise e na avaliaç" +
        "ão das relações sociais, dos modelos econômicos, dos processos políticos e das diversas culturas.");
    ...
    public static readonly AreaDeConhecimento CienciasAgrarias = new AreaDeConhecimento(23, 
        "Ciências Agrárias", 
        "<b>Ciências Agrárias</b>\n\nA área de Ciências Agrárias trata dos aspectos de exploração da terra, de criação de animais e de cultivo de vegetais. Su" +
        "as atividades possuem o objetivo de aumentar a produção, aprimorar as tecnologias de manejo e preservação dos recursos na" +
        "turais.");
