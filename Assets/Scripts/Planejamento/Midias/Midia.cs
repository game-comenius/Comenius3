    ...
    public Midia (NomeDeMidia nomeMidia)
    {
        ...
        switch (nomeMidia)
        {
            case NomeDeMidia.Lousa:
                nome = "Lousa";
                descricao = "A <b>lousa</b> é uma superfície reutilizável, geralmente riscada com giz branco, utilizada para exposição do conteúdo "+
            ...
            case NomeDeMidia.Televisao:
                nome = "Televisão";
                descricao = "A <b>televisão</b> é um meio de comunição de massa. Um sistema eletrônico de transmissão e recepção de imagens e sons gerados ao" +
            ...
            case NomeDeMidia.Aplicativos:
                nome = "Aplicativos";
                descricao = "<b>Aplicativos</b> são programas de software presentes em celulares e diversos dispositivos inteligentes, como smart TVs que des" +
            ...
            case NomeDeMidia.ProjetorMultimidia:
                ...
                descricao = "Um <b>projetor multimídia</b> é um aparelho óptico mecânico capaz de produzir imagens, como fotos, vídeos, filmes, planilhas, sl" +
